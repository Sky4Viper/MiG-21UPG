...
var AcModel        = props.globals.getNode("controls");
var OurHdg         = props.globals.getNode("orientation/heading-deg");
var OurRoll        = props.globals.getNode("orientation/roll-deg");
var OurPitch       = props.globals.getNode("orientation/pitch-deg");
var HudReticleDev  = props.globals.getNode("controls/suo/hud/reticle-total-deviation", 1);#polar coords
var HudReticleDeg  = props.globals.getNode("controls/suo/hud/reticle-total-angle", 1);
...
var AIM = {
	...
	new : func (p, type = "AIM-9", sign = "Sidewinder") {
		...
		m.prop              = AcModel.getNode("suo/"~m.type_lc~"/").getChild("msl", 0 , 1);
		m.SwSoundOnOff      = AcModel.getNode("suo/"~m.type_lc~"/sound-on-off");
        m.SwSoundVol        = AcModel.getNode("suo/"~m.type_lc~"/sound-volume");
		m.PylonIndex        = m.prop.getNode("pylon-index", 1).setValue(p);
		m.ID                = p;
		m.pylon_prop        = props.globals.getNode("payload/armament").getChild("station", p);
		m.Tgt               = nil;
		m.callsign          = "Unknown";
		...
		# AIM specs:
		m.aim9_fov_diam         = getprop("controls/suo/"~m.type_lc~"/FCS-field-deg");
		m.aim9_fov              = m.aim9_fov_diam / 2;
		m.max_detect_rng        = getprop("controls/suo/"~m.type_lc~"/max-fire-range-nm");
		m.max_seeker_dev        = getprop("controls/suo/"~m.type_lc~"/seeker-field-deg") / 2;
		m.force_lbs_1           = getprop("controls/suo/"~m.type_lc~"/thrust-lbf-stage-1");
		m.force_lbs_2           = getprop("controls/suo/"~m.type_lc~"/thrust-lbf-stage-2");
		m.stage_1_duration      = getprop("controls/suo/"~m.type_lc~"/stage-1-duration-sec");
		m.stage_2_duration      = getprop("controls/suo/"~m.type_lc~"/stage-2-duration-sec");
		m.weight_launch_lbs     = getprop("controls/suo/"~m.type_lc~"/weight-launch-lbs");
		m.weight_whead_lbs      = getprop("controls/suo/"~m.type_lc~"/weight-warhead-lbs");
		m.Cd_base               = getprop("controls/suo/"~m.type_lc~"/drag-coeff");
		m.eda                   = getprop("controls/suo/"~m.type_lc~"/drag-area");
		m.max_g                 = getprop("controls/suo/"~m.type_lc~"/max-g");
		#m.searcher_beam_width   = getprop("controls/suo/"~m.type_lc~"/searcher-beam-width");
		m.arming_time           = getprop("controls/suo/"~m.type_lc~"/arming-time-sec");
		m.min_speed_for_guiding = getprop("controls/suo/"~m.type_lc~"/min-speed-for-guiding-mach");
		m.selfdestruct_time     = getprop("controls/suo/"~m.type_lc~"/self-destruct-time-sec");
		m.guidance              = getprop("controls/suo/"~m.type_lc~"/guidance");
		m.all_aspect            = getprop("controls/suo/"~m.type_lc~"/all-aspect");
		m.vol_search            = getprop("controls/suo/"~m.type_lc~"/vol-search");
		m.vol_track             = getprop("controls/suo/"~m.type_lc~"/vol-track");
		m.vol_track_weak        = getprop("controls/suo/"~m.type_lc~"/vol-track-weak");
		m.angular_speed         = getprop("controls/suo/"~m.type_lc~"/seeker-angular-speed-dps");
        m.loft_alt              = getprop("controls/suo/"~m.type_lc~"/loft-altitude");
        m.min_dist              = getprop("controls/suo/"~m.type_lc~"/min-fire-range-nm");
        m.rail                  = getprop("controls/suo/"~m.type_lc~"/rail");
        m.rail_dist_m           = getprop("controls/suo/"~m.type_lc~"/rail-length-m");
        m.rail_forward          = getprop("controls/suo/"~m.type_lc~"/rail-point-forward");
        m.class                 = getprop("controls/suo/"~m.type_lc~"/class");
        m.brevity               = getprop("controls/suo/"~m.type_lc~"/fire-msg");
        m.reportDist            = getprop("controls/suo/"~m.type_lc~"/max-report-distance");
		m.aim_9_model           = getprop("controls/suo/models")~type~"/"~m.type_lc~"-";
		m.elapsed_last          = 0;
...
#printf("Alt %05.1f ft", alt_ft);
	...
	animation_flags_props: func {
		...
		var msl_path = "controls/suo/"~me.type_lc~"/flags/msl-id-" ~ me.ID;
		me.msl_prop = props.globals.initNode( msl_path, 1, "BOOL", 1);
		var smoke_path = "controls/suo/"~me.type_lc~"/flags/smoke-id-" ~ me.ID;
		me.smoke_prop = props.globals.initNode( smoke_path, 0, "BOOL", 1);
		var explode_path = "controls/suo/"~me.type_lc~"/flags/explode-id-" ~ me.ID;
		me.explode_prop = props.globals.initNode( explode_path, 0, "BOOL", 1);
		var explode_smoke_path = "controls/suo/"~me.type_lc~"/flags/explode-smoke-id-" ~ me.ID;
		me.explode_smoke_prop = props.globals.initNode( explode_smoke_path, 0, "BOOL", 1);
		var explode_sound_path = "controls/suo/flags/explode-sound-on-" ~ me.ID;;
		me.explode_sound_prop = props.globals.initNode( explode_sound_path, 0, "BOOL", 1);
		var explode_sound_vol_path = "controls/suo/flags/explode-sound-vol-" ~ me.ID;;
...
SW_reticle_Blinker = aircraft.light.new("controls/suo/hud/hud-sw-reticle-switch", [0.1, 0.1]);
setprop("controls/suo/hud/hud-sw-reticle-switch/enabled", 1);
